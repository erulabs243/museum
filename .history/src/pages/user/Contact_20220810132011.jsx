    ...
    return (
        <main>
            ...
            <section className="py-6 bg-gray-50 text-gray-700 h-5/6">
                <div className="flex flex-col items-center px-6 mx-auto lg:px-8 divide-y">
                    ...
                    <form
                        noValidate=""
                        className="flex flex-col w-2/3 py-6 space-y-6 md:py-0 md:px-6 ng-untouched ng-pristine ng-valid">
