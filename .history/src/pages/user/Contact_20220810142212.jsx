            ...
            <section className="pt-6 pb-12 bg-gray-50 text-gray-700 h-5/6">
                <div className="flex flex-col items-center px-6 mx-auto lg:px-8">
                    ...
                    <form
                        ...
                        <button
                            type="button"
                            className="self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75 bg-red-500 text-gray-700 focus:ring-red-500 hover:ring-red-500 border-0">
                            Envoyer le message
                        </button>
                    </form>
                </div>
