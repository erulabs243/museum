...
const Story = () => {
    return (
        <main>
            ...
            <article className="max-w-5xl px-6 py-24 mx-auto space-y-12 bg-gray-50 text-gray-700">
                ...
                <div className="text-gray-700 tracking-tight text-xl leading-relaxed">
                    <p>
                        ...
                        quis exercitation. <br /> Ex ex nostrud anim cupidatat anim. Ea non pariatur
                        mollit id consequat nulla irure. Mollit sunt magna elit ipsum culpa minim
                        laborum dolor tempor dolore magna veniam consectetur. Consectetur proident
                        ullamco fugiat incididunt. Veniam dolore irure ipsum Lorem tempor qui dolor
                        exercitation qui exercitation non excepteur. Exercitation in aute elit
                        dolore ex ipsum consectetur occaecat magna. <br /> Duis eu proident tempor
                        aliquip fugiat. Quis tempor cillum do do cupidatat veniam anim. Magna ex
                        occaecat ullamco minim pariatur id adipisicing ipsum ad proident consequat
                        elit ullamco. Amet fugiat consectetur aute eu cillum officia in qui. Non
                        pariatur amet dolor aliquip. Dolore excepteur labore dolor voluptate
                        eiusmod. Eu commodo do magna Lorem amet eu deserunt nulla. Et ut aliqua et
                        proident eu non et ut minim ut eiusmod veniam ad. Magna consequat
                        consectetur ullamco nulla exercitation pariatur do ad velit et Lorem velit
                        dolore.
                    </p>
                </div>
            </article>
