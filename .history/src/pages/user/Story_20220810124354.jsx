            ...
            <article className="max-w-2xl px-6 py-24 mx-auto space-y-12 bg-gray-50 text-gray-700">
                ...
                <div className="text-gray-700">
                    <p>
                        ...
                        dolore ex ipsum consectetur occaecat magna. <br className="py-3" /> Duis eu
                        proident tempor aliquip fugiat. Quis tempor cillum do do cupidatat veniam
                        anim. Magna ex occaecat ullamco minim pariatur id adipisicing ipsum ad
                        ...
                        dolor voluptate eiusmod. Eu commodo do magna Lorem amet eu deserunt nulla.
                        Et ut aliqua et proident eu non et ut minim ut eiusmod veniam ad. Magna
                        consequat consectetur ullamco nulla exercitation pariatur do ad velit et
                        Lorem velit dolore.
                    </p>
                </div>
            </article>
