        ...
        <main>
            ...
            <section className="pt-6 pb-12 bg-gray-50 text-gray-700 h-5/6">
                <div className="flex flex-col items-center px-6 mx-auto lg:px-8">
                    ...
                    <form
                        noValidate=""
                        className="flex flex-col w-full md:w-2/3 lg:w-2/5 py-12 space-y-6 px-12 ng-untouched ng-pristine ng-valid bg-red-500 rounded-3xl">
                        ...
                        <button
                            type="button"
                            className="self-center px-8 py-3 text-lg rounded focus:ring hover:ring focus:ring-opacity-75 bg-gray-700 text-gray-50 focus:ring-gray-700 hover:ring-gray-700">
                            Envoyer le message
                        </button>
                    </form>
                </div>
