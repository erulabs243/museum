        ...
        <main>
            ...
            <section className="pt-6 pb-12 bg-gray-50 text-gray-700 h-5/6">
                <div className="flex flex-col items-center px-6 mx-auto lg:px-8">
                    ...
                    <form
                        noValidate=""
                        className="flex flex-col w-2/5 py-12 space-y-6 px-12 ng-untouched ng-pristine ng-valid bg-red-500 rounded-3xl shadow-2xl">
                        <label className="block">
                            ...
                            <input
                                ...
                                required
                                className="block w-full rounded-lg mt-2 focus:ring focus:ring-opacity-75 focus:ring-red-500 bg-gray-50 text-gray-700"
                            />
                        </label>
                        <label className="block">
