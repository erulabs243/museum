                ...
                <div className="flex flex-col items-center px-6 mx-auto lg:px-8">
                    ...
                    <form
                        ...
                        <label className="block">
                            <span className="mb-3 text-gray-50">Nom complet</span>
                            <input
                                type="text"
                                placeholder="Nom complet"
                                required
                                className="block w-full rounded-md shadow-sm focus:ring focus:ring-opacity-75 focus:ring-red-500 bg-gray-800 text-gray-50"
                            />
                        </label>
                        <label className="block">
                            <span className="mb-3 text-gray-50">Adresse e-mail</span>
                            <input
                                type="email"
                                required
                                placeholder="xyz@example.cd"
                                className="block w-full rounded-lg shadow-sm focus:ring focus:ring-opacity-75 focus:ring-red-500 bg-gray-800 text-gray-50"
                            />
                        </label>
                        <label className="block">
                            <span className="mb-3 text-gray-50">Message</span>
                            <textarea
                                required
                                placeholder="Laissez-nous un message..."
                                rows="7"
                                className="block w-full rounded-lg focus:ring focus:ring-opacity-75 focus:ring-red-500 bg-gray-800 text-gray-50"></textarea>
                        </label>
                        <button
                            type="button"
