        ...
        <main>
            ...
            <section>
                <div className="grid grid-cols-2">
                    <div className="bg-red-500 text-gray-50 p-24">
                        <h1 className="text-3xl text-left py-3 px-3 font-semibold">Mission</h1>
            ...
            <section>
                <div className="grid grid-cols-2">
                    <div></div>
                    <div className="bg-red-500 text-gray-50 p-24">
                        <h1 className="text-3xl text-right py-3 font-semibold">Vision</h1>
                        <p className="text-xl w-2/3 text-gray-700 mx-auto py-6">
                            Ipsum qui quis incididunt ipsum ex eu fugiat labore ut ipsum do aliqua
                            ex. Est reprehenderit minim sunt dolor et nulla esse magna qui esse. Est
                            qui eu est fugiat nulla velit magna ipsum amet est adipisicing laboris
            ...
            <section>
                <div className="grid grid-cols-2">
                    <div className="bg-red-500 text-gray-50 p-24">
                        <h1 className="text-3xl text-left py-3 font-semibold">Valeurs</h1>
                        <p className="text-xl w-2/3 text-gray-700 mx-auto py-6">
                            Ipsum qui quis incididunt ipsum ex eu fugiat labore ut ipsum do aliqua
                            ex. Est reprehenderit minim sunt dolor et nulla esse magna qui esse. Est
                            qui eu est fugiat nulla velit magna ipsum amet est adipisicing laboris
            ...
            <section className="py-24 bg-gray-50">
                <div className="flex flex-col w-2/3 mx-auto">
                    <h1 className="font-semibold text-4xl text-red-500 py-3 text-right">
                        A propos de nous
                    </h1>
                    <div className="grid grid-cols-2 py-3">
                        <div></div>
