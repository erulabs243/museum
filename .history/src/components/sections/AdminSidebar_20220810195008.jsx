...
const AdminSidebar = () => {
    return (
        <div className="flex flex-col h-screen p-3 w-60 bg-red-500 text-gray-100">
            <div className="space-y-3">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        name="Search"
                        placeholder="Search..."
                        className="w-full py-2 pl-10 text-sm border-transparent rounded-md focus:outline-none bg-gray-800 text-gray-100 focus:bg-gray-900"
                    />
                </div>
            ...
            <div className="flex items-center p-2 mt-12 space-x-4 justify-self-end absolute bottom-4 rounded-xs hover:bg-gray-700">
                <img
