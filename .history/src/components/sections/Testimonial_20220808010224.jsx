    ...
    <section className="my-8">
      <div className="container flex flex-col items-center p-4 mx-auto space-y-6 md:p-8">
        ...
        <p className="px-6 py-2 text-2xl text-center sm:font-bold sm:text-3xl md:text-4xl lg:max-w-2xl xl:max-w-4xl text-gray-700">
          &ldquo;Veniam quidem animi ea maxime odit fugiat architecto perferendis ipsum perspiciatis
          iusto, provident qui nam dolorum corporis.&rdquo;
        </p>
        <div className="flex justify-center space-x-3">
          ...
          <div>
            ...
            <a className="flex items-center py-2 space-x-1 text-sm text-gray-50" href="/">
