...
const Home = () => {
    return (
        <main>
            ...
            {/* STATISTIQUES */}
            <section className="px-6 py-24 md:p-24 bg-gray-50 text-gray-700">
                <h1 className="text-5xl font-bold text-center py-12 md:p-12">
                ...
                <div className="container mx-auto grid justify-center grid-cols-2 text-center lg:grid-cols-4">
                    <div className="flex flex-col justify-start m-4 lg:m-6">
        ...
        <li>
          <article>
            ...
            {/* PARTENAIRES */}
            <section className="py-24 px-6 md:p-24 bg-gray-50 text-gray-700">
